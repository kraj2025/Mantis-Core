  ...
  const handleAddRow = () => {
    setTableData((prevTableData) => [
      ...prevTableData,
      {
        ...
        Percent: "",
        Amount: "",
        Remark: visible?.showData?.Remark || "",
        Cancel: "",
        NetAmount: visible?.showData?.NetAmount || 0,
      },
    ]);
  };
  ...
  const handleSaleConvert = () => {
    ...
    tableData?.map((val, index) => {
      ...
      DatePayload?.push({
        ...
        Remark: val?.Remark ? val?.Remark : visible?.showData?.Remark,
        Terms: val?.Terms,
        TermsID: val?.TermsID,
      });
    });
      ...
      <div className="card p-2">
        <div className="d-flex">
          ...
          <span style={{ fontWeight: "bold", marginLeft: "20px" }}>
            Net Amount:- {visible?.showData?.NetAmount}
          </span>
          <span style={{ fontWeight: "bold", marginLeft: "20px" }}>
          ...
          {formData?.EmailStatus == "1" && (
            <>
              <textarea
                ...
                style={{ width: "220px", marginLeft: "7.5px", height: "60px" }}
              ></textarea>
              <textarea
                type="text"
                className="summaryheightRemark"
              ...
              tbody={tableData.map((ele, index) => ({
                ...
                Terms: (
                  <Input
                    ...
                    placeholder=" "
                    onChange={(e) => searchHandleChange(e, index)}
                    value={ele?.Terms ? ele?.Terms : visible?.showData?.Terms}
                    // respclass="col-xl-12 col-md-4 col-sm-6 col-12 mt-2"
                  />
                ),
                Remark: (
                  <textarea
                    ...
                    onChange={(e) => searchHandleChange(e, index)}
                    value={
                      ele?.Remark ? ele?.Remark : visible?.showData?.Remark
                    }
                    style={{ width: "170px", marginLeft: "7.5px" }}
                  ></textarea>
                ),
                Cancel: (
                  // <span
...
export default SaleConvertModal;
