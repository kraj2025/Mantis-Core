    ...
    axiosInstances
      ...
      .then((res) => {
        if (res.data.success === true) {
          ...
          const tickets = apiData.map((item) =>
            Number(item?.TotalManHours || 0)
          );
          const manminutes = apiData.map((item) =>
            Number(item?.FreeManMinutes || 0)
          );
          ...
          setChartData({
            ...
            datasets: [
              {
                label: "Total ManMinutes",
                data: tickets,
                borderColor: "rgba(93, 157, 230, 0.9)",
                backgroundColor: "rgba(93, 157, 230, 0.9)",
                tension: 0.4,
              },
              {
                label: "Free ManMinutes",
                data: manminutes,
                borderColor: "#a7db37e6",
                backgroundColor: "#a7db37e6",
                tension: 0.4,
              },
            ],
          });
...
export default DeveloperFreeHours;
